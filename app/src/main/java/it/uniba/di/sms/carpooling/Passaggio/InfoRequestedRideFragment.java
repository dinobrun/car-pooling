...
public class InfoRequestedRideFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_info_requested_ride, container, false);
        ...
        }else if(passaggioParam.getConcluso()!=0){
            buttonTracking.setText(R.string.concluded);
        }
